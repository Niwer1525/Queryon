...
public class InsertionManager extends QueryExecutor {
    ...
    // private InsertionManager(DataBase db, Class<? extends Table> table, boolean ignoreIfExists) {
    //     super(db, table);
    ...
    //  */
    // public static InsertionManager insert(DataBase db, Class<? extends Table> table) { return new InsertionManager(db, table, false); }
    ...
    //  * @param table The table to select from
    //  */
    // public static InsertionManager insertOrIgnore(DataBase db, Class<? extends Table> table) { return new InsertionManager(db, table, true); }
    ...
    // public InsertionManager valueNull(String column) {
    //     VALUES.put(column, ValueToken.raw("NULL"));
    //     return this;
    // }

    // public InsertionManager valueDefault(String column) {
    ...
    //  */
    // public InsertionManager valueExpression(String column, String expression, Object... params) {
    ...
    //  */
    // public InsertionManager row(Map<String, Object> values) {
    ...
    //  */
    // public InsertionManager fromSelect(String selectSql, Object... params) {
    ...
    //  */
    // public InsertionManager as(String alias) {
    ...
    //  */
    // public InsertionManager onConflict(String... columns) {
    ...
    // public InsertionManager doNothingOnConflict() {
    //     this.conflictDoNothing = true;
    //     this.CONFLICT_UPDATE.clear();
    //     return this;
    // }

    // public InsertionManager doUpdateSet(String column, Object value) {
    ...
    //  */
    // public InsertionManager doUpdateSetExcluded(String column) {
    //     this.conflictDoNothing = false;
    //     this.CONFLICT_UPDATE.put(column, ValueToken.raw("excluded." + column));
    //     return this;
    // }

    // public InsertionManager doUpdateWhere(String sqlCondition, Object... params) {
    ...
    // public InsertionManager returningAll() {
    //     this.returningClause = "*";
    //     return this;
    // }

    // public InsertionManager returning(String... columns) {
    ...
    //     final BuiltQuery built = buildQuery();
    //     return InteractionManager.queryUpdateCount(this.DATA_BASE, built, built.params().toArray());
    // }
    ...
    //     final BuiltQuery built = buildQuery();
    //     return InteractionManager.query(this.DATA_BASE, serializer, built, built.params().toArray());
    // }
    ...
    //     return new BuiltQuery(query.toString(), params);
    // }
